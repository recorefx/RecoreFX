...
namespace Recore.Linq
{
    ...
    {
        /// <summary>
        /// Creates a <c cref="LinkedList{T}">LinkedList&lt;T&gt;</c>
        /// from an <c cref="IEnumerable{T}">IEnumerable&lt;T&gt;</c>.
        /// </summary>
        /// <remarks>
        ...
        /// operations on an <c cref="IEnumerable{T}">IEnumerable&lt;T&gt;</c>
        ...
        /// <c cref="LinkedList{T}">LinkedList&lt;T&gt;</c> a suitable data structure for storing the elements.
        /// </remarks>
